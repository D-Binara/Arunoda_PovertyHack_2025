...
export const mockStoryPacks: StoryPack[] = [
  {
    ...
    description: 'Learn to save money wisely through real-life stories and practical exercises.',
    category: 'Money Management',
    downloadSize: 120,
    thumbnail: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=400&h=300&fit=crop',
    stories: [
      { id: 's1', packId: 'pack_savings', title: 'Why Saving Matters', description: 'Understand the importance of saving money.' },
      { id: 's2',packId: 'pack_savings', title: 'Budgeting Basics', description: 'Create a personal budget that works.' },
      { id: 's3',packId: 'pack_savings', title: 'Cutting Expenses', description: 'Learn simple tricks to reduce unnecessary spending.' },
      { id: 's4',packId: 'pack_savings', title: 'Emergency Fund', description: 'Set up an emergency fund for peace of mind.' },
      { id: 's5',packId: 'pack_savings', title: 'Investing Wisely', description: 'Intro to safe and smart investing for beginners.' },
    ],
    badges: ['Smart Saver', 'Money Master', 'Budget Pro'],
    progress: 60,
    isDownloaded: true,
    featured: true,
  },
  {
    ...
    description: 'Step-by-step guide to starting and growing your small business successfully.',
    category: 'Entrepreneurship',
    downloadSize: 180,
    thumbnail: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=400&h=300&fit=crop',
    stories: [
      { id: 'b1',packId: 'pack_business', title: 'Idea Validation', description: 'Test your business idea before investing.' },
      { id: 'b2',packId: 'pack_business', title: 'Business Plan Basics', description: 'How to write a simple and effective business plan.' },
      { id: 'b3',packId: 'pack_business', title: 'Marketing Strategies', description: 'Low-cost marketing strategies to reach customers.' },
      { id: 'b4',packId: 'pack_business', title: 'Financial Management', description: 'Track expenses, revenue, and profits.' },
      { id: 'b5',packId: 'pack_business', title: 'Scaling Up', description: 'Grow your business sustainably.' },
    ],
    badges: ['Business Builder', 'Entrepreneur', 'Growth Hacker'],
    progress: 30,
    isDownloaded: false,
  },
  {
    ...
    description: 'Master mobile banking, online payments, and essential digital skills.',
    category: 'Digital Skills',
    downloadSize: 150,
    thumbnail: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=400&h=300&fit=crop',
    stories: [
      { id: 'd1',packId: 'pack_digital', title: 'Mobile Banking', description: 'Learn to safely use mobile banking apps.' },
      { id: 'd2',packId: 'pack_digital', title: 'Online Payments', description: 'How to pay and receive money digitally.' },
      { id: 'd3',packId: 'pack_digital', title: 'Digital Security', description: 'Protect your accounts and information.' },
      { id: 'd4',packId: 'pack_digital', title: 'Productivity Tools', description: 'Use digital tools for daily tasks.' },
      { id: 'd5',packId: 'pack_digital', title: 'Social Media Basics', description: 'Set up profiles and connect safely online.' },
    ],
    badges: ['Digital Star', 'Tech Savvy', 'Online Pro'],
    progress: 0,
    isDownloaded: false,
  },
];
